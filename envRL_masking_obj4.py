...
class Routing(Env):
    ...
    def step(self, action):
        ...
        risk = edgeattr['duration'] + nodeattr['duration']
        ...
        #     if isinstance(self.observation_space[key], Discrete):
        #         n = self.observation_space[key].n
        #         if value >= n or value < 0:
        #             print(f"CRASH REPORT: Key '{key}' has invalid value {value}. Max allowed is {n - 1}.")
        # print(action)
        # print(reward)
