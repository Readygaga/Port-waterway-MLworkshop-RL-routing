...
# Objective: Travel the least while satisfy the minimum 800 catch
...
class Routing(Env):
    def __init__(self, Graph: Graph, Ship: Ship, start):
        ...
        self.state = {'route': locations.index(start), 'pathCatch': 0, 'pathDistance': 0}
    ...
    def step(self, action):
        ...
        self.state = {'route': action, 'pathCatch': self.ship.catch, 'pathDistance': distance}
        reward = -distance
        info = {}
