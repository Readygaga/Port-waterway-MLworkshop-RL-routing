...
File with name Env_training_testing is the file which includes all the code to set up a training environment, testing the environment, training of an agent, testing etc. In case you prefer to work in one script.
